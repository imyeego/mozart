...
/**
 * @authur : liuzhao
 * @time : 5/16/21 10:25 PM
 * @Des :
 */
public class RoundCornerTransform implements Transformation<Bitmap> {

    private BitmapPool mBitmapPool;

    private float radius;

    private boolean leftTop, rightTop, leftBottom, rightBotoom;
     ...
     * @param rightBottom
     */
    public void setCorner(boolean leftTop, boolean rightTop, boolean leftBottom, boolean rightBottom) {
        this.leftTop = leftTop;
        this.rightTop = rightTop;
        this.leftBottom = leftBottom;
        this.rightBotoom = rightBottom;
    }

    public RoundCornerTransform(Context context, float radius) {
